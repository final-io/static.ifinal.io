...
function darkMode(e) {
    const t = document.getElementsByTagName("body")[0], a = document.querySelectorAll("div:not(.sidenav) > hr"),
        ...
        h = document.querySelectorAll(".card.border"), y = document.querySelectorAll(".card.border.border-dark"),
        b = document.querySelectorAll(".main-content .container-fluid .card"), p = document.querySelectorAll("g");
